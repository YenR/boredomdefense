                ...
                for(int i=0; i<wi; i++)
                {
                    ...
                    if(plates[i][j].e != null)
                    {
                        ...
                        if(plates[i][j].e.next_step <= 0)
                        {
                            ...
                            while(plates[i][j].e != null && halp < 10)
                            {
                                
                                if(plates[i][j].e.up == false)  // move down
                                {
                                    if(j< hi-1)
                                    {
                                ...
                                if(plates[i][j].e != null)
                                {
                                    ...
                                    if(plates[i][j].e != null)
                                    {
                                        if(plates[i][j].e.right == false)    // move left
                                        {
                                            if(i > 0)
                                            {
                                                if(plates[i-1][j].t == null)
...
//                                                        plates[i][j].e.up = false;
                            ...
                            if(halp>=9)
                            {
                                ...
                                if(plates[i][j].e.enrage<=50)
                                {
                                    plates[i][j].e.up = !plates[i][j].e.up;
                                    plates[i][j].e.right = !plates[i][j].e.right;
                                }
                                
                                if(plates[i][j].e.enrage<=0)
                                {
                                    if(j<hi-1)
                                    {
                                        if(plates[i][j+1].t!= null)
        ...
        public void run() {
            try
                ...
                if(enemies == null)
                {
                    ...
                    timer3.scheduleAtFixedRate(new Next(), 7500, 10000);
